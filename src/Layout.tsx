  ...
  const [projectsList] = useState<IProjectsContext>({
    projects: [
      new Project(
        ...
        2023,
        "School project",
        "https://elsasportfolio.netlify.app/naturesite.png",
        "REPLICATE DESIGN",
      ...
      new Project(
        ...
        2023,
        "School project",
        "https://elsasportfolio.netlify.app/todolist.png",
        "TO DO LIST",
        "Made at medieinstitutet by Elsa Eriksson",
      ...
      new Project(
        ...
        2024,
        "School project",
        "https://elsasportfolio.netlify.app/whiskends.png",
        "THE WEBSHOP",
      ...
      new Project(
        ...
        2024,
        "School project",
        "https://elsasportfolio.netlify.app/thezoo.png",
        "THE ZOO",
        "Made at medieinstitutet by Elsa Eriksson",
      ...
      new Project(
        ...
        2024,
        "School project",
        "https://elsasportfolio.netlify.app/smakriket.png",
        "THE RESTAURANT",
      ...
      new Project(
        ...
        2024,
        "School project",
        "https://elsasportfolio.netlify.app/thechat.png",
        "THE CHAT",
